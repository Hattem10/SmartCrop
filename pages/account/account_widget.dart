                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => Text(
                          valueOrDefault(currentUserDocument?.expLvl, ''),
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
                                fontFamily: 'Mulish',
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('ACCOUNT_PAGE_Row_s8mu4uko_ON_TAP');
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('ACCOUNT_PAGE_Row_jdn94fgm_ON_TAP');
                        logFirebaseEvent('Row_navigate_to');

                        context.pushNamed('SeasonUpdate');
                      },
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('ACCOUNT_PAGE_Row_s5g0xqun_ON_TAP');
                        logFirebaseEvent('Row_navigate_to');

                        context.pushNamed('LocationUpdate');
                      },
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('ACCOUNT_PAGE_Row_erfzs2a4_ON_TAP');
                        logFirebaseEvent('Row_navigate_to');

                        context.pushNamed('LanguageChanger');
                      },
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
