...
import 'schema/crop_record.dart';
...
export 'schema/crop_record.dart';
...
/// Functions to query CropRecords (as a Stream and as a Future).
Future<int> queryCropRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CropRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CropRecord>> queryCropRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CropRecord.collection,
      CropRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CropRecord>> queryCropRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
