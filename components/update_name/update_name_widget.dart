...
import 'update_name_model.dart';
export 'update_name_model.dart';
...
class _UpdateNameWidgetState extends State<UpdateNameWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateNameModel());
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'UPDATE_NAME_close_rounded_ICN_ON_TAP');
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'UPDATE_NAME_COMP_UPDATE_BTN_ON_TAP');
