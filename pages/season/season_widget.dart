...
class _SeasonWidgetState extends State<SeasonWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeasonModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Season'});
  }
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'o35gap0q' /* Choose season you would like t... */,
                      ),
                    ...
                    child: Container(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        hintText: FFLocalizations.of(context).getText(
                          'pavthci9' /* Please select a season */,
                        ),
                        searchHintText: FFLocalizations.of(context).getText(
                          '69nk9e16' /* Search for a region */,
                        ),
                        searchCursorColor:
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('SEASON_PAGE_CONTINUE_BTN_ON_TAP');
