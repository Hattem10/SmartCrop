...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF87B187);
  late Color secondary = const Color(0xFF66A865);
  late Color tertiary = const Color(0xFFF8F8F8);
  late Color alternate = const Color(0xFFF5F4F2);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0x80000000);
  late Color primaryBackground = const Color(0xFFF8F8F8);
  late Color secondaryBackground = const Color(0xFFF5F4F2);
  late Color accent1 = const Color(0xFF458244);
  late Color accent2 = const Color(0xFFC8C4B7);
  late Color accent3 = const Color(0xFFBFD8AF);
  late Color accent4 = const Color(0xCDFFFFFF);
  late Color success = const Color(0xFF00FF18);
